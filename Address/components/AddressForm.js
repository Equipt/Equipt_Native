...
const AddressForm = ({
  ...
  <View style={ styles.form }>
    <View style={ styles.inlineFields }>
      <TextInput style={[styles.formField, styles.unit]} defaultValue={  address.unit || session.address.unit } placeholder="Unit" onChangeText={ unit => actions.updateAddressField(address) }/>
      <TextInput style={[styles.formField, styles.address]} defaultValue={  address.street || session.address.street } placeholder="Address" onChangeText={ address => actions.updateAddressField(address) }/>
    </View>
